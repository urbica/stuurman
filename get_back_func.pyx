...
def _bidirectional_astar(G, source_coords, 
...
def beautiful_path(G, source_coords, heuristic, spatial_index, dataset, coords, 
    ...
    if first_step == None:
        ...
        second_step = beautiful_path(G, coords[best], heuristic, spatial_index, dataset, coords, 
                       cutoff, additional_param, avoid = node_paths[best][:-av1], first_step = first)
        ...
        path3 = _bidirectional_astar(G,  target_coords, source_coords, heuristic, spatial_index, dataset, 
